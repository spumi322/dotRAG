...
**[[1.1 Memory Architecture|Session 1.1 — Memory Architecture]]**
- Stack & Heap
- Value vs Reference types
- Boxing / Unboxing
- `struct` vs `class`

**[[1.2 Fundamental Types|Session 1.2 — Fundamental Types]]**
...
**[[1.3 Modern Type Features|Session 1.3 — Modern Type Features]]**
...
**[[3.1 OOP Pillars|Session 3.1 — OOP Pillars]]**
- Encapsulation, Inheritance, Polymorphism, Abstraction
- Composition over Inheritance

**[[3.2 Abstraction Mechanisms|Session 3.2 — Abstraction Mechanisms]]**
- Abstract class vs Interface — when to use which
- C# 8 default interface methods

**[[3.3 Csharp Keywords & Polymorphism|Session 3.3 — C# Keywords & Polymorphism]]**
...
**[[5.1 .NET Internals|Session 5.1 — .NET Internals]]**
...
**[[5.2 Garbage Collection|Session 5.2 — Garbage Collection & Disposal]]**
- GC generations (0/1/2), mark-and-sweep, LOH
- `IDisposable`, `Dispose` vs `Finalize`, `using`

**[[5.3 Async & Concurrency|Session 5.3 — Async & Concurrency]]**
...
**[[5.4 Exceptions|Session 5.4 — Exceptions]]**
- `throw` vs `throw ex`
...
**[[6.1 Architecture & Middleware|Session 6.1 — Architecture & Middleware]]**
...
**[[6.4 Auth, HTTP & REST|Session 6.4 — Auth, HTTP & REST]]**
...
**[[6.5 Serialization & Error Handling|Session 6.5 — Serialization & Error Handling]]**
- `System.Text.Json`, Accept header negotiation
- Global exception handling middleware
- `ILogger<T>`, logging levels, structured logging

**[[6.6 HTTP Client & Resiliency|Session 6.6 — HTTP Client & Resiliency]]**
...
**[[7.2 Querying|Session 7.2 — Querying]]**
...
**[[7.4 EF Core|Session 7.4 — EF Core]]**
...
**[[11.1 DevOps & Tooling|Session 11.1 — DevOps & Tooling]]**
